...
$("#application-quiz-submit").on("click",function() {
    ...
    windowTimeout = setTimeout(checkAnswersAfterTimeUp, 60 * 1000);
...
function checkAnswersAfterTimeUp () {
    ...
    // // this will display the incorrect answers selected==============

    for (var i = 0; i < lengthOfIncompleteQuiz; i++) {
    ...
    //     // this will display missedAnswersArray in the dom ========
        for (var i = 0; i < missedAnswerArray.length; i++) {
            ...
            for (var i = (lengthOfIncompleteQuiz + 1); i < lengthOfQuiz; i ++) {
                var questionDiv = $("<div>").attr("class", "result-question");
                questionDiv.text("Code: " + examArray[i].question);
                var correctDiv = $("<div>").attr("class", "result-correct-answer");
                correctDiv.text("Correct Answer: " + examArray[i].correctAnswer);
                var lineSpace = $("<br><hr>");
